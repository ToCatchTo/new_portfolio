...
const HeaderCard = ({ miniText, title }: HeaderCardProps) => {
	return (
		<Box sx={{ border: `1px solid ${colors.border}`, padding: { md: '25px', sm: '20px', xs: '15px' }, display: 'flex', flexDirection: 'column', gap: { md: '10px', sm: '5px', xs: '0px' }, width: '100%', justifyContent: 'center' }}>
